# To Run this script: python sampling_random_node.py <year>
...
plt.suptitle('Average Bias/Average Clustering Coefficient vs Random node sample % plot till year '+str(curyear), fontsize=14)
plt.xlabel('Random node sample %')
plt.ylabel('Average Bias/Average Clustering Coefficient')
plt.savefig('../graphs/Average Bias by Average Clustering Coefficient vs Random node sample % plot till year '+str(curyear)+'.png')
plt.close()

plt.figure()
plt.xlim(0,60)
plt.plot(samplepercents100,avgdvalues,'r^-')
plt.suptitle('K-S statistic value for degree distribution vs Random node sample % plot till year '+str(curyear), fontsize=14)
plt.xlabel('Random node sample %')
plt.ylabel('K-S statistic value for degree distribution')
plt.savefig('../graphs/K-S statistic value for degree distribution vs Random node sample % plot till year '+str(curyear)+'.png')
plt.close()
