...
echo'<font face="verdana"><b>';
	...
	{			$_SESSION['q4']=$_POST['q4'];
				...
				echo'<form name="form4ds53df2" action="startfresh6.php" method="post">';
				...
				if($i==5)
				{
					...
					$result=mysqli_query($con,$query);
						...
						echo '</table><br><br><input type="submit" name="sub5" value="Submit">';
						}
			...
			header('Location: startfresh6.php');
			}
