...
{ 	
	...
	<html>
	<head>
		<title> Un-Confirm Students by Roll
		</title>
	</head>
	<body bgcolor="blue" text="white">
	<center><font face="verdana">
	<h2>Un-Confirm Students Page </h2><hr>
	<form name="form8" action="unconfirmstudents_get.php" method="get">	
					...
					$roll=$_GET['roll'];
						...
						$result1 = mysqli_query($con,"SELECT roll FROM users WHERE roll = $roll");
							if($result1)
							{
								...
								{
									// some data matched
									$result=mysqli_query($con,"update users set status=2 where roll=$roll");
									if($result)
									{
									echo '<center>Successfully un-confirmed !!<br><a href="confirmstudents.php">Click here to confirm another student</a>';
