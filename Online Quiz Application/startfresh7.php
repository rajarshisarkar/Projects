...
echo'<font face="verdana"><b>';
	...
	{			$_SESSION['q6']=$_POST['q6'];
				...
				echo'<form name="formsdf4ds53df2" action="startfresh8.php" method="post">';
				...
				if($i==7)
				{
					...
					$result=mysqli_query($con,$query);
						...
						echo '</table><br><br><input type="submit" name="sub7" value="Submit">';
						}
			...
			header('Location: startfresh8.php');
			}
}
