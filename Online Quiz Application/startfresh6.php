...
echo'<font face="verdana"><b>';
	...
	{			$_SESSION['q5']=$_POST['q5'];
				...
				echo'<form name="formsdf4ds53df2" action="startfresh7.php" method="post">';
				...
				if($i==6)
				{
					...
					$result=mysqli_query($con,$query);
						...
						echo '</table><br><br><input type="submit" name="sub6" value="Submit">';
						}
			...
			header('Location: startfresh7.php');
			}
}
