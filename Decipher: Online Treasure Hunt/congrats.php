...
<?php
if($_SESSION['normaluser']=='normaluser' && $_SESSION['level']==21)
{
...
<hr color="#CC0000">
<p><strong> <center>
  <font size="5">Congrats !</strong><br></font>
  </h2><center>Congrats you have completed all the levels ! Sit back and relax till the leaderboard is finalised !';
