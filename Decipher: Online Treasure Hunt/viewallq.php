...
<p>
  <strong> <center>
  <font size="5">View all Questions</strong><br></font><br>
  </h2><center>
  <table border=1 width="1300"><tr><th>Q No.</th><th>Q Description</th><th>Lifeline 1</th><th>Lifeline 2</th><th>Image name</th><th>Answer</th></tr>';
$query="select * from questions";
			...
			$result=mysqli_query($con,$query);
				...
				{ 
					echo'<tr><td><center>'.$row[0].'<td><center>'.$row[1].'</td><td><center>'.$row[2].'</td><td><center>'.$row[3].'</td><td><center>'.$row[4].'</td><td><center>'.$row[5].'</td></tr>';
