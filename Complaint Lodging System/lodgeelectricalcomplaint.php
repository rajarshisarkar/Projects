...
<body background="images/background.bmp">
	...
	if($_SESSION['normaluser']=='normaluser' && $_SESSION['uname'])
	{
		...
		if(!isset($_POST['save']) and !isset($_POST['exit']))
		{
			...
			<form name="lodgeelectricalcomplaint" action="lodgeelectricalcomplaint.php" method="post">
			<table border="1" width="650">
			<tr><td width="3" style="border-right:1px"><div align="right"><img src="images/favicon.gif"></img></div></td><td width="380" style="border-left:1px"><center><b>Construction and Maintenance<br>(Township)<br>RDCIS, SAIL, Ranchi</td><td width="210"><center><b>Service Requisition Form Electrical</td><td width="210"><center><b>Complaint ID: <input type="text" name="pageno" style="width: 80px" readonly></td></tr>
			...
			<tr><td width="175" colspan="2"><font align="left"><b>&nbsp;&nbsp;Job Sl. No.: <input type="text" name="jobslno" style="width: 70px" readonly><br></td><td rowspan="2" colspan="2"><div align="right" class="linebreak"><b><br><br>Status: <select name="status" style="width: 100px" readonly><option value="N">New</option></select>&nbsp;&nbsp;</div></td></tr>
		...
		else if(isset($_POST['save']))
		{
			...
			if(strcmp($loc_id,'')==0)
			{
				...
				echo '<script language="javascript">window.location = "lodgeelectricalcomplaint.php"</script>';
			}
			...
			$query="select max(comp_id) from rdcis_online_req_form where fin_year='$finyear' and CIVIL_ELEC = 'E' ";
			$result = oci_parse($con, $query);
			oci_execute($result);
			$row = oci_fetch_array($result, OCI_ASSOC+OCI_RETURN_LOBS);
			...
			else
			{
				...
				<form name="lodgeelectricalcomplaint" action="lodgeelectricalcomplaint.php" method="post">
				<table border="1" width="650">
				<tr><td width="3" style="border-right:1px"><div align="right"><img src="images/favicon.gif"></img></div></td><td width="380" style="border-left:1px"><center><b>Construction and Maintenance<br>(Township)<br>RDCIS, SAIL, Ranchi</td><td width="210"><center><b>Service Requisition Form Electrical</td><td width="210"><center><b>Complaint ID: <input type="text" value="'.$id.'" name="pageno" style="width: 80px" readonly></td></tr>
				<tr><td width="175"><center><b>Date</td><td width="175"><center><b>Location</td><td width="1000" colspan="2"><center><b>Description of Service Required</td></tr>
				...
				echo "<script type='text/javascript'>alert('Electrical Complaint Lodged Successfully. Your Complain ID is $comp_id. Please note down your Complaint ID for future reference.');</script>";	
			}
