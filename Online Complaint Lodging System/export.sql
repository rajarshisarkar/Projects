--------------------------------------------------------
--  File created - Saturday-December-14-2013   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table LOCATION_DET
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."LOCATION_DET" 
   (	"LOC_ID" NUMBER(6,0), 
	"LOC_NO" VARCHAR2(10 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOCATION_TYPE" 
   (	"LOC_ID" NUMBER(6,0), 
	"LOC_NAME" VARCHAR2(1024 BYTE), 
	"LOC_DESC" VARCHAR2(1024 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
--  DDL for Table ONLINE_USERS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."ONLINE_USERS" 
   (	"PLNO_OWNER" VARCHAR2(30 BYTE), 
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table RDCIS_ONLINE_REQ_FORM
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."RDCIS_ONLINE_REQ_FORM" 
   (	"FIN_YEAR" NUMBER(8,0), 
	"COMP_ID" NUMBER(5,0), 
	"COMP_ID_DATE" DATE, 
	"CIVIL_ELEC" VARCHAR2(1 BYTE), 
	"PLNO_OWNER" VARCHAR2(6 BYTE), 
	"MAY_BE_ATTENDED" VARCHAR2(1 BYTE), 
	"STATUS" VARCHAR2(1 BYTE), 
	"COMP_DESC" VARCHAR2(1024 BYTE), 
	"LOC_ID" NUMBER(6,0), 
	"LOC_NO" VARCHAR2(6 BYTE), 
	"COMP_NO" NUMBER(6,0) DEFAULT NULL, 
	"SUPPLIER_CODE" VARCHAR2(6 BYTE) DEFAULT NULL, 
	"CON_ORDER_NO" VARCHAR2(128 BYTE) DEFAULT NULL, 
	"COMP_DATE" DATE DEFAULT NULL, 
	"REASON_CANCEL" VARCHAR2(128 BYTE) DEFAULT NULL
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
--  DDL for Table ROOM_OCCUPANTS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."ROOM_OCCUPANTS" 
   (	"LOC_ID" NUMBER(6,0), 
	"LOC_NO" VARCHAR2(10 BYTE), 
	"OCCUPANT_ID" VARCHAR2(6 BYTE), 
	"DATE_FROM" DATE, 
	"DATE_TO" DATE DEFAULT NULL, 
	"REMARKS" VARCHAR2(1024 BYTE) DEFAULT NULL
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME) values ('6D77B16936EB4BC894E859547F6CB27F',74399,'ORDERS_QUEUE',74046,0,0,5,0,0,0,null,null,null,null,null);
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME) values ('EDD868B7130D4C7D93C6B2DAD1983A77',74400,'AQ$_ORDERS_QUEUETABLE_E',74046,1,0,0,0,0,0,'exception queue',null,null,null,null);
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME) values ('D4158718F92B48AA99E9F250DAB56C5A',74403,'STREAMS_QUEUE',74062,0,0,5,0,0,0,null,null,null,null,null);
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME) values ('684222633BE94B59AC1DDC2DE46BD6F0',74404,'AQ$_STREAMS_QUEUE_TABLE_E',74062,1,0,0,0,0,0,'exception queue',null,null,null,null);
...
REM INSERTING into SYSTEM.LOCATION_DET
SET DEFINE OFF;
Insert into SYSTEM.LOCATION_DET (LOC_ID,LOC_NO,REMARKS) values (20,'A-20','My cabin');
Insert into SYSTEM.LOCATION_DET (LOC_ID,LOC_NO,REMARKS) values (21,'A-21','Mudit''s cabin');
REM INSERTING into SYSTEM.LOCATION_TYPE
SET DEFINE OFF;
Insert into SYSTEM.LOCATION_TYPE (LOC_ID,LOC_NAME,LOC_DESC) values (20,'Cabin of Rajarshi Sarkar','Cabin in Administrative Block');
Insert into SYSTEM.LOCATION_TYPE (LOC_ID,LOC_NAME,LOC_DESC) values (21,'Cabin of Mudit Garg','Cabin in Administrative Block');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.ONLINE_USERS
SET DEFINE OFF;
Insert into SYSTEM.ONLINE_USERS (PLNO_OWNER,USERNAME,PASSWORD) values ('ER0001','Rajarshi Sarkar','ER0001');
Insert into SYSTEM.ONLINE_USERS (PLNO_OWNER,USERNAME,PASSWORD) values ('ER0002','Mudit Garg','ER0002');
REM INSERTING into SYSTEM.RDCIS_ONLINE_REQ_FORM
SET DEFINE OFF;
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,1,to_date('11-DEC-13','DD-MON-RR'),'C','ER0001','A','N','broken sink',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,2,to_date('11-DEC-13','DD-MON-RR'),'C','ER0001','A','N','broken sink',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,3,to_date('11-DEC-13','DD-MON-RR'),'C','ER0001','A','N','broken sink',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,4,to_date('11-DEC-13','DD-MON-RR'),'C','ER0001','A','N','broken sink',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,5,to_date('11-DEC-13','DD-MON-RR'),'C','ER0001','A','N','broken sink',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,6,to_date('11-NOV-13','DD-MON-RR'),'C','ER0001','A','N','broken sink',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,7,to_date('11-OCT-13','DD-MON-RR'),'C','ER0001','A','N','broken sink',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,8,to_date('11-SEP-13','DD-MON-RR'),'C','ER0001','A','N','broken sink',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,9,to_date('11-AUG-13','DD-MON-RR'),'C','ER0001','A','N','broken sink',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,10,to_date('11-JUL-13','DD-MON-RR'),'C','ER0001','A','N','broken sink',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,11,to_date('11-JUN-13','DD-MON-RR'),'E','ER0001','A','N','broken something ',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,12,to_date('11-MAY-13','DD-MON-RR'),'E','ER0001','F','N','test with oracle database',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,13,to_date('11-APR-13','DD-MON-RR'),'E','ER0001','N','N','orcl database',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,14,to_date('11-MAR-13','DD-MON-RR'),'C','ER0001','F','N','orcl database civil',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,15,to_date('11-DEC-13','DD-MON-RR'),'C','ER0001','A','N','sadj',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,16,to_date('11-DEC-13','DD-MON-RR'),'E','ER0001','N','N','ajdh',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,17,to_date('11-DEC-13','DD-MON-RR'),'C','ER0001','N','N','dj',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,18,to_date('11-DEC-13','DD-MON-RR'),'E','ER0001','F','N','asjdj',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,19,to_date('11-DEC-13','DD-MON-RR'),'C','ER0001','F','N','ad',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,20,to_date('11-DEC-13','DD-MON-RR'),'C','ER0002','F','R','asd',21,'A-21',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,21,to_date('11-DEC-13','DD-MON-RR'),'C','ER0002','F','N','asd',21,'A-21',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,22,to_date('11-DEC-13','DD-MON-RR'),'C','ER0001','F','N','zc',21,'A-21',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,23,to_date('11-DEC-13','DD-MON-RR'),'C','ER0001','A','N','sdf',21,'A-21',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,24,to_date('11-DEC-13','DD-MON-RR'),'E','ER0001','A','N','d',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,25,to_date('11-DEC-13','DD-MON-RR'),'E','ER0001','A','N','af',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,26,to_date('11-DEC-13','DD-MON-RR'),'E','ER0001','A','N','SAIL RDCIS',21,'A-21',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,27,to_date('11-DEC-13','DD-MON-RR'),'C','ER0001','A','N','df',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,28,to_date('11-DEC-13','DD-MON-RR'),'E','ER0001','A','N','sdf',21,'A-21',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,29,to_date('11-DEC-13','DD-MON-RR'),'C','ER0001','A','N','lfsjsjlf',21,'A-21',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,30,to_date('12-DEC-13','DD-MON-RR'),'C','ER0001','A','N','new date',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,31,to_date('13-DEC-13','DD-MON-RR'),'C','ER0001','A','N','sdfsdf',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,32,to_date('13-DEC-13','DD-MON-RR'),'C','ER0001','A','N','sdf',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,33,to_date('13-DEC-13','DD-MON-RR'),'C','ER0001','A','N','sfd',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,34,to_date('13-DEC-13','DD-MON-RR'),'C','ER0001','A','N','sdf',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,35,to_date('13-DEC-13','DD-MON-RR'),'C','ER0001','A','N','sdg',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,36,to_date('13-DEC-13','DD-MON-RR'),'E','ER0001','A','N','sdf',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,37,to_date('13-DEC-13','DD-MON-RR'),'E','ER0001','A','N','zc',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,38,to_date('13-DEC-13','DD-MON-RR'),'C','ER0001','A','N','sdf',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,39,to_date('13-DEC-13','DD-MON-RR'),'E','ER0001','A','N','sf',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,40,to_date('13-DEC-13','DD-MON-RR'),'E','ER0001','A','N','sf',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,41,to_date('13-DEC-13','DD-MON-RR'),'E','ER0001','A','N','sf',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,42,to_date('13-DEC-13','DD-MON-RR'),'E','ER0001','A','N','sf',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,43,to_date('13-DEC-13','DD-MON-RR'),'E','ER0001','A','N','asd',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,44,to_date('13-DEC-13','DD-MON-RR'),'E','ER0001','A','N','asd',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,45,to_date('13-DEC-13','DD-MON-RR'),'E','ER0001','A','N','sdf',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,46,to_date('13-DEC-13','DD-MON-RR'),'E','ER0001','A','N','sdf',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,47,to_date('13-DEC-13','DD-MON-RR'),'E','ER0001','A','N','sdf',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,48,to_date('13-DEC-13','DD-MON-RR'),'E','ER0001','F','N','sdf',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,49,to_date('13-DEC-13','DD-MON-RR'),'E','ER0001','F','N','sdf',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,50,to_date('13-DEC-13','DD-MON-RR'),'E','ER0001','N','N','daf',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,51,to_date('13-DEC-13','DD-MON-RR'),'E','ER0001','A','N','djf',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,52,to_date('13-DEC-13','DD-MON-RR'),'E','ER0001','A','N','sdf',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,53,to_date('13-DEC-13','DD-MON-RR'),'E','ER0001','A','N','sdf',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,54,to_date('13-DEC-13','DD-MON-RR'),'E','ER0001','A','N','sfddsf',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,55,to_date('13-DEC-13','DD-MON-RR'),'E','ER0001','F','N','dsakj',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,56,to_date('13-DEC-13','DD-MON-RR'),'E','ER0001','A','N','sdf',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,57,to_date('13-DEC-13','DD-MON-RR'),'E','ER0001','A','N','sakjd',21,'A-21',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,58,to_date('13-DEC-13','DD-MON-RR'),'E','ER0001','A','N','sakjd',21,'A-21',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,59,to_date('13-DEC-13','DD-MON-RR'),'C','ER0001','A','N','hi',21,'A-21',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,60,to_date('13-DEC-13','DD-MON-RR'),'C','ER0001','N','N','askjdk',21,'A-21',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,61,to_date('13-DEC-13','DD-MON-RR'),'E','ER0001','A','N','sdfkj',21,'A-21',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,62,to_date('13-DEC-13','DD-MON-RR'),'C','ER0001','A','N','sfd',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,63,to_date('13-DEC-13','DD-MON-RR'),'C','ER0001','A','N','sdfdf',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,64,to_date('14-DEC-13','DD-MON-RR'),'C','ER0001','F','N','sdf',20,'A-20',null,null,null,null,null);
Insert into SYSTEM.RDCIS_ONLINE_REQ_FORM (FIN_YEAR,COMP_ID,COMP_ID_DATE,CIVIL_ELEC,PLNO_OWNER,MAY_BE_ATTENDED,STATUS,COMP_DESC,LOC_ID,LOC_NO,COMP_NO,SUPPLIER_CODE,CON_ORDER_NO,COMP_DATE,REASON_CANCEL) values (20132014,62,to_date('14-DEC-13','DD-MON-RR'),'E','ER0001','N','N','sfd',20,'A-20',null,null,null,null,null);
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.ROOM_OCCUPANTS
SET DEFINE OFF;
Insert into SYSTEM.ROOM_OCCUPANTS (LOC_ID,LOC_NO,OCCUPANT_ID,DATE_FROM,DATE_TO,REMARKS) values (20,'A-20','ER0001',to_date('02-SEP-94','DD-MON-RR'),null,null);
Insert into SYSTEM.ROOM_OCCUPANTS (LOC_ID,LOC_NO,OCCUPANT_ID,DATE_FROM,DATE_TO,REMARKS) values (21,'A-21','ER0002',to_date('21-FEB-95','DD-MON-RR'),null,null);
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table LOCATION_DET
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."LOCATION_DET" MODIFY ("LOC_ID" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."LOCATION_DET" MODIFY ("LOC_NO" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."LOCATION_DET" MODIFY ("REMARKS" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table LOCATION_TYPE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."LOCATION_TYPE" MODIFY ("LOC_ID" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."LOCATION_TYPE" MODIFY ("LOC_NAME" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."LOCATION_TYPE" MODIFY ("LOC_DESC" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ONLINE_USERS" MODIFY ("PLNO_OWNER" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."ONLINE_USERS" MODIFY ("USERNAME" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."ONLINE_USERS" MODIFY ("PASSWORD" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."ONLINE_USERS" ADD PRIMARY KEY ("PLNO_OWNER")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
...
--------------------------------------------------------
--  Constraints for Table ROOM_OCCUPANTS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."ROOM_OCCUPANTS" MODIFY ("LOC_ID" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."ROOM_OCCUPANTS" MODIFY ("LOC_NO" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."ROOM_OCCUPANTS" MODIFY ("OCCUPANT_ID" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."ROOM_OCCUPANTS" MODIFY ("DATE_FROM" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table RDCIS_ONLINE_REQ_FORM
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."RDCIS_ONLINE_REQ_FORM" MODIFY ("FIN_YEAR" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."RDCIS_ONLINE_REQ_FORM" MODIFY ("COMP_ID" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."RDCIS_ONLINE_REQ_FORM" MODIFY ("COMP_ID_DATE" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."RDCIS_ONLINE_REQ_FORM" MODIFY ("CIVIL_ELEC" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."RDCIS_ONLINE_REQ_FORM" MODIFY ("PLNO_OWNER" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."RDCIS_ONLINE_REQ_FORM" MODIFY ("MAY_BE_ATTENDED" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."RDCIS_ONLINE_REQ_FORM" MODIFY ("STATUS" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."RDCIS_ONLINE_REQ_FORM" MODIFY ("COMP_DESC" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."RDCIS_ONLINE_REQ_FORM" MODIFY ("LOC_ID" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."RDCIS_ONLINE_REQ_FORM" MODIFY ("LOC_NO" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."RDCIS_ONLINE_REQ_FORM" ADD PRIMARY KEY ("FIN_YEAR", "COMP_ID", "CIVIL_ELEC")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
